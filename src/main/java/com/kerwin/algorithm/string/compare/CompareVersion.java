...
public class CompareVersion {
     ...
     * @return
     */
    public static int splitCompareVersion(String version1, String version2){
        ...
        while (index < v1.length || index < v2.length){
            int x = 0,y = 0;
            if(index < v1.length){
                x = Integer.parseInt(v1[index]);
            }
            if(index < v2.length){
                y = Integer.parseInt(v2[index]);
            }
            if(x != y){
                return x > y?1:-1;
            }
     ...
     * @return
     */
    public static int pointerCompareVersion(String version1, String version2){
